...
char* prog_name[] = { "mmap", "brk", "read", "write", "open", "mmap", "munmap", "clone", "yield", "waitpid", "dup2", "dup", "exec", "exit", "fork", "getpid", "getppid", "gettimeofday", "uname", "sleep", "times", "pipe", "wait", "open" };
